...
// Define each handler separately
const getHotelComplaints = async (req, res) => {
    try {
...
const getGuestComplaints = async (req, res) => {
    try {
...
const addPredefinedComplaint = async (req, res) => {
    try {
...
const getPredefinedComplaints = async (req, res) => {
    try {
...
const addStaffMessage = async (req, res) => {
    try {
